...
var tasks = [
	...
	[
		"Finally, select only the id and phone_num attributes of the company_profiles table and get the records where the id is between 40 and 60",
...
*/
sqltest.testCommands('sqlchallenges/sql-1-8.sql', "people", tasks);
